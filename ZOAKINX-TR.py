...
class Work():
    ...
    def startit(self):
        ...
        asklogo = '''
[1]. Hesap açma formu ( 83 formunu gönderir. )

[2]. Hesap açma formu ( 38 formunu gönderir. )
        '''
    ...
    def askCrem(self):
        self.name = input(self.YELLOW+"[+] Hesabın içerisinde kayıtlı olan Ad Soyad : ")
        self.username = str(input(self.YELLOW+"[+] Hesabın Kullanıcı Adı : "))
        self.email = input(self.YELLOW+"[+] E-posta Adresi : ")
        self.reason = open("message.txt", 'r').read()
        self.country = str(input(self.YELLOW+"[+] Ülke olarak nereyi seçmek istersin ? : "))
        self.sleep = int(input(self.YELLOW+"[+] Gönderme hızı ne kadar olsun ( Saniye olarak yazın )  : "))

        self.useprx = str(input(self.BLUE+'[?] Proxy Kullansın mı ? y/n : '))
    ...
    def askspam(self):
        ...
        self.email = input(self.YELLOW+"[+] E-posta Adresi : ")
        self.reason = open("message.txt", 'r').read()
        self.phone = input(self.YELLOW+"[+] Hesaba kayıtlı telefon numarası :  ")
